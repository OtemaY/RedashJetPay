SELECT date_trunc('month', CAST("public"."payments_transaction"."updated_at" AS timestamp)) AS "updated_at", count(*) AS "count"
...
WHERE (("public"."payments_transaction"."status" = 'paid'
   ...
   "public"."payments_transaction"."total_amount_paid" >= 9 AND 
   "public"."payments_transaction"."created_at" >= timestamp with time zone '2021-05-02 00:00:00.000Z' AND
   "account_account__via__payer_ac"."is_demo_account" = FALSE AND
   ("public"."payments_transaction"."vendor_account_id" = 384 OR
   "public"."payments_transaction"."vendor_account_id" = 587
